  ...
  <div class="container text-md-start">
    <div class="row text-md-start">
      ...
      <div class="col-md-4 col-lg-4 col-xl-3 mx-auto mt-3">
        <h5 class="text-uppercase mb-4 font-weight-bold text-warning">Orderly</h5>
        <p>
          123 Main Street<br>
          City, Country<br>
          Email: info@orderly.com<br>
          Phone: +123 456 7890
        </p>
      </div>
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <a href="#" class="btn btn-outline-light btn-floating m-1" role="button"><i class="bi bi-linkedin"></i></a>
      </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-5 col-lg-4 text-md-end">
        <p class="text-light mb-0">
          Designed by Danijel Cvijanovic
        </p>
      </div>
    </div>
  </div>
